...
Assuming that the two signals have the same phase, there is a way to find the frequency ratio of two signals using lissajous figures. There are many cases\\
...
\begin{itemize}
\item It can be used to find the frequency ratio of two signals, if all we know about them is that they have the same phase (i.e, 0 phase difference).
\item It can be used to find the amplitude ratio of two signals, if all we know about them is that they have the same frequency and phase.
