...
The trigger in a DSO is a tool to capture any particular event, such as a sudden rise (edge), a pulse of a particular width, a runt (a smaller/different pulse among a set of pulses).
